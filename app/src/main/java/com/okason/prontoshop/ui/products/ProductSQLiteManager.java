...
/**
 * Created by Valentine on 4/14/2016.
 */
public class ProductSQLiteManager implements ProductListContract.Repository{
    ...
    public ProductSQLiteManager(Context context) {
        mContext = context;
